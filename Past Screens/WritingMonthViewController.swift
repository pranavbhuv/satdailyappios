//
//  WritingMonthViewController.swift
//  SAT Daily
//
...
class WritingMonthViewController: UIViewController {
    ...
    @objc public func buttonClicked(_ sender: UIButton) {
        ...
        performSegue(withIdentifier: "toWQ", sender: self)
    }
    
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        let vc = segue.destination as! PastWritingViewController
