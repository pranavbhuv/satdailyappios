//
//  ReadingMonthViewController.swift
//  SAT Daily
//
...
class ReadingMonthViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // In year 2022 we have to rework this to start from January
        ...
        for monthNumber in 2...monthnum {
          let button = UIButton()
            ...
            button.setTitle("Passages for: \(dateFormatterPrint.string(for: releasedate)!)", for: .normal)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        let vc = segue.destination as! PastReadingViewController
